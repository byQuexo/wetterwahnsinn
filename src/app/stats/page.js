    ...
    <>
      <div className="flex h-screen gap-12 min-w-min">
        ...
        <div className="flex-1 flex flex-col min-w-min gap-4">
          ...
          <div className="h-5/6 w-5/6" style={{ backgroundColor: "#808080", margin: "20px", padding: "10px", borderRadius: "12px" }}>
              ...
              <LineChart
                ...
                style={{ backgroundColor: "#f0f0f0", padding: "20px", margin: "15px", borderRadius: "12px" }}>
